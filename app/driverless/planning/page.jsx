...
const Planning = () => {
    ...
    { name: "CAN", logo: <FaNetworkWired /> },
    { name: "Perception", logo: <BsHddNetworkFill /> },
            ...
            <div className="container mx-auto h-full">
                ...
                <div className="text-center xl:text-left order-2 xl:order-none">
                    ...
                    <p className="max-w-[500px] mb-9 text-white/80 text-sm md:text:mg lg:text-lg">
                        Know more about our planning sub-division, where we focus on building planning systems that use our perception systems to make informed decisions around the track. If any part of that interested you, this might be the right place for you
                    </p>
                ...
                <div className="order-1 xl:order-none mb-12 xl:mb-0 mt-12 xl:mt-0">
                    <div className="relative">
                        ...
                        >
                            <source src="/assets/videos/perception.mp4" type="video/mp4" />
                        </video>
                        </div>
                    </div>
                </div>
